...
public class AmplParameterSpecTest {
    ...
    public void equalsAndHashCode() {
        ...
        a = ParameterSpec.builder(int.class, "i").addModifiers(javax.lang.model.element.Modifier.STATIC).build();
        b = ParameterSpec.builder(int.class, "i").addModifiers(javax.lang.model.element.Modifier.STATIC).build();
        com.google.common.truth.Truth.assertThat(a.equals(b)).isTrue();
        com.google.common.truth.Truth.assertThat(a.hashCode()).isEqualTo(b.hashCode());
    }
